...
% (but using all ball trials).

% Assume neural data is already filtered.

% Hopefully avoids the need to balance number of trials (and therefore run
% for many subsamples).
...
% An alternative could be to normalise using day 1 every time?
