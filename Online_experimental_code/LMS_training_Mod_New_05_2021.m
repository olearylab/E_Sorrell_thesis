...
if model_params.balance_hist
    if sum(ismember(model_params.xnums,7))>0
        [wrapped_va_new,ztrainfilt_new] = balance_training_histogram_general(xvars(train_valid,model_params.xnums==7),ztrainfilt(train_valid,:),model_params.balance_nbins);
    ...
    if sum(ismember(model_params.xnums,15))>0
        ...
        [yaw_new,ztrainfilt_new] = balance_training_histogram_general(xvars(train_valid,model_params.xnums==15)-offset,ztrainfilt(train_valid,:),model_params.balance_nbins);
