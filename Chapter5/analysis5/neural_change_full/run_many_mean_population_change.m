...
for m = 1:num_mice
    for d = 1:num_days
        if ~isempty(z_cell{m,d})
            ...
            % [all_popboot_mean{m,d},all_neuron_means{m,d},all_overall_n_means{m,d}] = assess_mean_population_change_14092022(virmen_cell{m,d},z_cell{m,d},tbt_cell{m,d},model_params,linearise_x,nbins,boot_samps,xnum,sub_sample,normalise_z,type_groups);
