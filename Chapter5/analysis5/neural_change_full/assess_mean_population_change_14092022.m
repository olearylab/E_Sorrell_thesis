function [population_bootstrap_mean,neuron_means,overall_n_means] = assess_mean_population_change_14092022(virmen_data,zdata,tbt_details,model_params,linearise_x,nbins,boot_samps,xnum,sub_sample,normalise_z,type_groups)
% 14/09/2022
...
% subsample to match number of trials for normalising as well as overall
% mean calculations
