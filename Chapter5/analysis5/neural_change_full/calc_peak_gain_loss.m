...
% For each neuron, determine whether it is untuned, tuned to both left,
% tuned to both right, gained left tuning, lost left tuning, gained right tuning lost right tuning

% will be both, gain, loss. Ignore untuned (assume removed/all are 0)
