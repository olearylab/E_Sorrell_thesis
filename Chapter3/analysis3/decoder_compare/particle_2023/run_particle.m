...
run_save_offline_particle(mice, data_days, model_params, 5, 80, true);
...
run_save_offline_2021_mice_particle(mice, data_days, model_params, 5, 80, true);