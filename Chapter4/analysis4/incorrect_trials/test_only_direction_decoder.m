function [results_struct] = test_only_direction_decoder(ztest, xtest, model_params, tbt_details, t_types, train_results_struct)
% 17/11/2021
%%
...
Wout = train_results_struct.Wout;
train_mean = train_results_struct.train_mean;
Rfixed = train_results_struct.Rfixed;
...
results_struct.xtrain = train_results_struct.xtrain;
results_struct.xprediction = xprediction;
results_struct.xtrainprediction = train_results_struct.xtrainprediction;
results_struct.train_valid = train_results_struct.train_valid;
