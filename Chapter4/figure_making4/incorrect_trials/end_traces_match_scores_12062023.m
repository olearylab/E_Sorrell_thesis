function [h_boots] = end_traces_match_scores_12062023(virmen_cell,tbt_cell,start_dist,offset_vec)
% 12/06/2023
...
hold on
% violin(full_res,'bw',0.01,'facecolor',[0.5,0.5,0.5],'medc',[],'edgecolor',[]);
